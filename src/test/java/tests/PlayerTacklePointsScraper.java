...
public class PlayerTacklePointsScraper {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            statsPage.waitForTacklePointsTable();
            
            System.out.println(statsPage.getTacklePointsHeaders());
            System.out.println("-----------------------------------");
            List<WebElement> rows = statsPage.getTacklePointsRows();
